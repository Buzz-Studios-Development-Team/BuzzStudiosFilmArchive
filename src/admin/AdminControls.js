...
export default function AdminControls(props) {
    ...
    const set = (film) => {
        ...
        details.setIndex(film.index !== undefined ? film.index : 0);
            ...
            {stage === Stage.REVIEW && 
                <Card variant="outlined" sx={{width: 700, margin: "0 auto"}}>
                    <CardContent style={{display: "flex", alignItems: "center", flexDirection: "column"}}>
                        ...
                        <p style={{fontSize: 18, marginTop: 0}}>Category: <strong>{filmDetails.getCategory() == 0 ? "Regular" : filmDetails.getCategory() == 1 ? "Veteran" : "Bonus"}</strong></p>
